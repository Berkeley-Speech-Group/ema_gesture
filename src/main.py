...
from models.csnmf import AE_CSNMF2, AE_CSNMF3, PR_Model
...
parser.add_argument('--num_factors', type=int, default=2, help='')
...
parser.add_argument('--resynthesis2', action='store_true', help='')
...
if __name__ == "__main__":
    ...
    elif args.resynthesis2:
        model = AE_CSNMF3(**vars(args)).to(device)
    else:
    ...
    elif args.resynthesis or args.resynthesis2:
